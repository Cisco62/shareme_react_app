...
import shareVideo from '../assets 2/share.mp4';
import logo from '../assets 2/logowhite.png';
...
const Login = () => {
    ...
    const onSuccess = (res) => {
        ...
        //Creating a sanity document for the user and save it in the database
        const doc = {
            _id: googleId,
            _type: 'user',
            userName: name,
...
// onSuccess={() => { console.log('Login Success') }} onError={() => { console.log('Login Failed') }}